...
type PositionServiceClient interface {
	...
	Get(ctx context.Context, in *PositionId, opts ...grpc.CallOption) (*GetPositionResponse, error)
	GetAll(ctx context.Context, in *GetAllPositionRequest, opts ...grpc.CallOption) (*GetAllPositionResponse, error)
	Update(ctx context.Context, in *GetPositionResponse, opts ...grpc.CallOption) (*PositionStatus, error)
	Delete(ctx context.Context, in *PositionId, opts ...grpc.CallOption) (*PositionStatus, error)
}
...
func (c *positionServiceClient) Get(ctx context.Context, in *PositionId, opts ...grpc.CallOption) (*GetPositionResponse, error) {
...
func (c *positionServiceClient) Update(ctx context.Context, in *GetPositionResponse, opts ...grpc.CallOption) (*PositionStatus, error) {
	out := new(PositionStatus)
...
func (c *positionServiceClient) Delete(ctx context.Context, in *PositionId, opts ...grpc.CallOption) (*PositionStatus, error) {
	out := new(PositionStatus)
...
type PositionServiceServer interface {
	...
	Get(context.Context, *PositionId) (*GetPositionResponse, error)
	GetAll(context.Context, *GetAllPositionRequest) (*GetAllPositionResponse, error)
	Update(context.Context, *GetPositionResponse) (*PositionStatus, error)
	Delete(context.Context, *PositionId) (*PositionStatus, error)
...
func (UnimplementedPositionServiceServer) Get(context.Context, *PositionId) (*GetPositionResponse, error) {
...
func (UnimplementedPositionServiceServer) Update(context.Context, *GetPositionResponse) (*PositionStatus, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Update not implemented")
}
func (UnimplementedPositionServiceServer) Delete(context.Context, *PositionId) (*PositionStatus, error) {
...
func _PositionService_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PositionServiceServer).Update(ctx, req.(*GetPositionResponse))
	}
	return interceptor(ctx, in, info, handler)
}
